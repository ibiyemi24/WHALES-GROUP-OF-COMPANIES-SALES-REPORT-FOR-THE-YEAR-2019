...
The Northern region is the top-performing sales region, while the Western region lags behind.

Nancy and Anne generate the highest individual revenue.

Beverages is the highest-performing product category.

A small number of customers dominate revenue contribution.
...
High dependency on a limited number of key customers and sales reps.

Certain regions and customers are underperforming, indicating potential market penetration issues.
...
Performed data splitting, preprocessing, and exploratory analysis.

Used Pivot Tables, Filters, Slicers, and multiple charts (bar, line, pie, and map).
...
Replicate Northern region success strategies in weaker regions such as the West and Nevada.

Strengthen customer loyalty programs for top-value clients and design targeted campaigns for mid-tier customers.

Prioritize and expand high-performing product categories, especially Beverages.

Use seasonal insights to plan inventory and marketing campaigns around peak sales months.
...
Clear roadmap for strategic decision-making in marketing, sales, product planning, and operational support.
